...
import { lucideChevronDown, lucideFolderOpen, lucidePlus, lucideTrash2, lucideCheck } from '@ng-icons/lucide';
...
@Component({
  ...
  providers: [provideIcons({ lucideChevronDown, lucideFolderOpen, lucidePlus, lucideTrash2, lucideCheck })],
